...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_v1_health_health_proto_rawDescGZIP(), []int{1, 0}
}
...
type HealthCheckResponse struct {
	...
	Status HealthCheckResponse_ServingStatus `protobuf:"varint,1,opt,name=status,proto3,enum=api.v1.health.HealthCheckResponse_ServingStatus" json:"status,omitempty"`
}
...
var file_v1_health_health_proto_rawDesc = []byte{
	...
	0x74, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
	0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x1a, 0x1c, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0xcc, 0x01, 0x0a, 0x13, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	...
	0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65,
	...
	0x4e, 0x47, 0x10, 0x02, 0x32, 0x86, 0x01, 0x0a, 0x0d, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x53,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x75, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68,
	0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x21, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x68,
	0x65, 0x61, 0x6c, 0x74, 0x68, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63,
	0x6b, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76,
	...
	0xe4, 0x93, 0x02, 0x19, 0x12, 0x17, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x76, 0x31, 0x2f, 0x68, 0x65,
	0x61, 0x6c, 0x74, 0x68, 0x2f, 0x6c, 0x69, 0x76, 0x65, 0x6e, 0x65, 0x73, 0x73, 0x42, 0xc6, 0x01,
	0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x68, 0x65, 0x61,
	...
	,
...
var file_v1_health_health_proto_goTypes = []any{
	(HealthCheckResponse_ServingStatus)(0), // 0: api.v1.health.HealthCheckResponse.ServingStatus
	(*HealthCheckRequest)(nil),             // 1: api.v1.health.HealthCheckRequest
	(*HealthCheckResponse)(nil),            // 2: api.v1.health.HealthCheckResponse
}
var file_v1_health_health_proto_depIdxs = []int32{
	0, // 0: api.v1.health.HealthCheckResponse.status:type_name -> api.v1.health.HealthCheckResponse.ServingStatus
	1, // 1: api.v1.health.HealthService.HealthCheck:input_type -> api.v1.health.HealthCheckRequest
	2, // 2: api.v1.health.HealthService.HealthCheck:output_type -> api.v1.health.HealthCheckResponse
...
func file_v1_health_health_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_v1_health_health_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_v1_health_health_proto_msgTypes[1].Exporter = func(v any, i int) any {
