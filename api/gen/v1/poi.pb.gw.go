...
func RegisterPoIQueryInfoHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PoIQueryInfoServer) error {
	...
	mux.Handle("GET", pattern_PoIQueryInfo_GetPoI_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.v1.PoIQueryInfo/GetPoI", runtime.WithHTTPPathPattern("/api/v1/poi/{id}"))
		if err != nil {
...
func RegisterPoIQueryInfoHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PoIQueryInfoClient) error {
	...
	mux.Handle("GET", pattern_PoIQueryInfo_GetPoI_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.v1.PoIQueryInfo/GetPoI", runtime.WithHTTPPathPattern("/api/v1/poi/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PoIQueryInfo_GetPoI_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "v1", "poi", "id"}, ""))
)
